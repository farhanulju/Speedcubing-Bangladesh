...
import { listContact, setContactStatus } from '../../../lib/inbox';

export const prerender = false;

type Env = SpeedbdEnv & { ADMIN_DEV_BYPASS?: string };

// GET /api/admin/contact?status= → inbox list (message bodies stay admin-only)
...
// POST /api/admin/contact { id, status: open|in_progress|closed }
