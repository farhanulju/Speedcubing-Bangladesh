...
- Full screenshot review across 360/768/1280px per route. A targeted production visual pass at 360px and desktop was completed 2026-09-16. The initially failing CMS draft save was retested after the user-reported fix and passed create + read-back as unpublished. A read-only follow-up validated additional public/admin UX issues; findings and inline screenshot index are in `plan/PRODUCTION_UI_QA_2026-09-16.md`.
