...
- Cloudflare free tier only. No Vercel, no paid DB, no external CMS, no Google Forms. Discourse is the single recorded future forum exception. See `docs/architecture/ARCHITECTURE.md`.
